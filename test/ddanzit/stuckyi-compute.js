...
var 자소ㄱㅅ = Hangul.assemble(['ㄱ', 'ㅅ']),
    자소ㄴㅈ = Hangul.assemble(['ㄴ', 'ㅈ']),
    자소ㄴㅎ = Hangul.assemble(['ㄴ', 'ㅎ']),
    자소ㄹㄱ = Hangul.assemble(['ㄹ', 'ㄱ']),
    자소ㄹㅁ = Hangul.assemble(['ㄹ', 'ㅁ']),
    자소ㄹㅂ = Hangul.assemble(['ㄹ', 'ㅂ']),
    자소ㄹㅅ = Hangul.assemble(['ㄹ', 'ㅅ']),
    자소ㄹㅌ = Hangul.assemble(['ㄹ', 'ㅌ']),
    자소ㄹㅍ = Hangul.assemble(['ㄹ', 'ㅍ']),
    자소ㄹㅎ = Hangul.assemble(['ㄹ', 'ㅎ']),
    자소ㅂㅅ = Hangul.assemble(['ㅂ', 'ㅅ']),
    자소우 = Hangul.disassemble('우')[1];
...
var 자소기준점리스트 = [
  ...
  for (var i = 0; i < 자소기준점리스트.length; i++) {
    ...
    for (var j = 0; j < 자소.length; j++) {
      var 손자소 = 자소[j];
      var 손자소사이점배열 = makePointByLerp(j, 손자소[0], 손자소[1], 10);
      console.log(손자소);
        console.log(손자소사이점배열);
...
//JSON화된 코드를 화면에 출력하는 부분이다.
function viewPosData() {
    console.log("viewPosData");
    var allStrings = "";
...
function makePointByLerp(index, start, end, len) {
  console.log(index);
    var resultArray = [];
    var eachPos = (1.0 / len);
    ...
    function addObject(jasoindex, obj) {
      console.log(jasoindex);
        switch (jasoindex) {
        case 1:
            dataset.ㄱ.push(obj);
            break;
        ...
        case 14:
            ...
            break;
        case 15:
            dataset.얇은ㄱ.push(obj);
            break;
        case 16:
            dataset.얇은ㄴ.push(obj);
            break;
        case 17:
            dataset.얇은ㄷ.push(obj);
            break;
        case 18:
            dataset.얇은ㄹ.push(obj);
            break;
        case 19:
            dataset.얇은ㅁ.push(obj);
            break;
        case 20:
            dataset.얇은ㅂ.push(obj);
            break;
        case 21:
            dataset.얇은ㅅ.push(obj);
            break;
        case 22:
            dataset.얇은ㅈ.push(obj);
            break;
        case 23:
            dataset.얇은ㅌ.push(obj);
            break;
        case 24:
            dataset.얇은ㅍ.push(obj);
            break;
        case 25:
            dataset.얇은ㅎ.push(obj);
            break;
        case 26:
            dataset.오.push(obj);
            break;
