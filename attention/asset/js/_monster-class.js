...
class 몬스터A {
    constructor(시작점, 글자이동점, 자소이동점, 자소타입) {
        ...
        this.횡적모음위치 = { x: this.글자이동점.x + m2 + this.g, y: this.글자이동점.y + m3 + this.b},    
...
class 몬스터B {
    constructor(시작점, 글자이동점, 자소이동점, 자소타입) {
        ...
        // 개선필요
        this.닿자위치 = { x: 글자이동점.x + this.g, y: 글자이동점.y + m1 + this.b },
        this.종적모음위치 = { x: 글자이동점.x + m4+ this.g, y: 글자이동점.y + this.b },
        this.횡적모음위치 = { x: 글자이동점.x + this.g, y: 글자이동점.y + m4 + this.b },
        this.받침위치 = { x: 글자이동점.x + this.g, y: 글자이동점.y + m4 + this.b };
